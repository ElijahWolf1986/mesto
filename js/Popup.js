export class Popup {
    ...
    setEventListeners() {
        ...
        closeButton.addEventListener('click', () => this.close()); //закрытие попапа по клику на крестик
        document.addEventListener('keydown', (evt) => this._handleEscClose(evt)); //закрытие попапа по клику на esc
